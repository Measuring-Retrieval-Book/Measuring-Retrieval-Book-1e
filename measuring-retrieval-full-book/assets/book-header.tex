...
\newcommand{\frontcover}{%
  \begin{titlepage}
  \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth,height=\paperheight]{assets/covers/front-fractal-dark.png}}
  \color{white}
  \vspace*{0.9in}
  ...
  \vfill
  {\sffamily\small Full manuscript edition\par}
  \end{titlepage}
...
\newcommand{\backcover}{%
  \cleardoublepage
  \thispagestyle{empty}
  \AddToShipoutPictureBG*{\includegraphics[width=\paperwidth,height=\paperheight]{assets/covers/back-fractal-light.png}}
  \vspace*{1.0in}
